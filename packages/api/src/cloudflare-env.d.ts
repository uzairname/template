/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv ../../packages/api/src/cloudflare-env.d.ts` (hash: 2f7882fffd88e9ff424ed7d2db16954b)
