/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv ../../packages/api/src/cloudflare-env.d.ts` (hash: 3062aecb5cb6db34fb23b3b9dd3f211d)
