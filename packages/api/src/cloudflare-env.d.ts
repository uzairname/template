/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv ../../packages/api/src/cloudflare-env.d.ts` (hash: 69ae54c628d031ff59948165c262ac31)
// Runtime types generated with workerd@1.20250924.0 2025-03-01 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("../../../apps/backend/src/index");
	}
	interface Env {
		ADMIN_BASE_URL: "http://localhost:3000" | "https://template-admin.5r.workers.dev";
		LANDING_BASE_URL: "http://localhost:3001" | "https://template-landing.5r.workers.dev";
		BACKEND_BASE_URL: "http://localhost:8989" | "https://template-backend.5r.workers.dev";
